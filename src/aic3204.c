...
// This code written by mmalex / Plinky
...
void write_all_codec_regs(void) {
    ...
    // DOSR=128, NDAC=1, set P=1, set D=0, set R=MDAC
    // 32*FS*MDAC*J = FS*MDAC*DOSR
...
// This code written by Stijn of TiNRS / This is not Rocket Science
...
void __isr __time_critical_func(audio_i2s_dma_irq_handler)()
{
    ...
    // volatile uint32_t fstat = pio1->fstat;
    // volatile uint32_t flevel = pio1->flevel;
